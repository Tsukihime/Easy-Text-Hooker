...
type
  ...
  private
    ...
    procedure OnRecieve(data: TAGTHMessage);
...
begin
  ...
  FPipeServer := TPipeServerSingleton.GetInstatnce;
  FPipeServer.OnReceiveSubscribe(OnRecieve);
end;

destructor TAGTHServer.Destroy;
begin
  FPipeServer.OnReceiveUnsubscribe(OnRecieve);
  FPipeServer := nil;
  FTimer.Free;
  FTextStreams.Free;
  inherited;
...
procedure TAGTHServer.OnRecieve(data: TAGTHMessage);
var
  i: Integer;
